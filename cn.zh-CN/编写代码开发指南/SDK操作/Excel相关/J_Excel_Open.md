# J\_Excel\_Open {#concept_w2y_r35_zdb .concept}

打开一个Excel文件并返回对象。

## 函数 {#section_ulr_t35_zdb .section}

J\_Excel\_Open\(文件路径, \[是否可见:否\], \[只读:否\],\[文件密码\], \[设置密码\]\)

## 返回值 {#section_yz1_535_zdb .section}

Excel对象。

## 样例 {#section_hth_535_zdb .section}
