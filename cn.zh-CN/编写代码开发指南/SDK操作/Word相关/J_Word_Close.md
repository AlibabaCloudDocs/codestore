# J\_Word\_Close {#concept_pp1_yhq_12b .concept}

关闭WordDoc文档。

## 函数 {#section_fzk_b3q_12b .section}

J\_Word\_Close\(Word对象\)

## 返回值 {#section_dlr_b3q_12b .section}

成功返回1，失败返回0。

## 样例 {#section_ysy_b3q_12b .section}
