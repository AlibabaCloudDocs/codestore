# J\_Word\_Create {#concept_fpv_g3q_12b .concept}

创建一个新的Word文档，并返回word对象。

## 函数 {#section_otf_j3q_12b .section}

J\_Word\_Create\(\[是否可见:否\]\)

## 返回值 {#section_s5m_j3q_12b .section}

Word对象。

## 样例 {#section_gnt_j3q_12b .section}
